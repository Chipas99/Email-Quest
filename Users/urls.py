...
from Users.views import LoginView, LogoutView, RegisterView, get_verification, RegisterInfo, UserListView, UserDetailView, UserDeleteView, PasswordResetView, UserPasswordChangeView, PasswordResetDoneView, \
